        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (mFirebaseUser != null) {
                    Toast.makeText(CustomerLogin.this, "Chào mừng trở lại", Toast.LENGTH_SHORT).show();
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    emailInput.setError("ID email là bắt buộc.");
                    return;
                }


                if (TextUtils.isEmpty(password)) {
                    passwordInput.setError("Mật khẩu là bắt buộc.");
                    return;
                }

                if (password.length() < 6) {
                    passwordInput.setError("Mật khẩu phải có nhiều hơn 6 ký tự");
                    return;
                }
                            ...
                            typeref.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                ...
                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                        if(documentSnapshot.exists()){
                                            ...
                                            Toast.makeText(CustomerLogin.this, "Đăng nhập thành công với tư cách là "+type, Toast.LENGTH_SHORT).show();
                                            assert type != null;
