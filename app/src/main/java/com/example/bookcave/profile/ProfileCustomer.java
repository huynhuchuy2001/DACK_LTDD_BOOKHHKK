        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(verifythis)){
                    ...
                    Toast.makeText(getApplicationContext(),"Nhập email chính xác của bạn để lưu các thay đổi",Toast.LENGTH_SHORT).show();
                    return;
                }
                else if(TextUtils.isEmpty(updatefn) ){
                    Toast.makeText(getApplicationContext(),"Nhập tên để cập nhật",Toast.LENGTH_LONG).show();
                    return;
                }
                else if(TextUtils.isEmpty(updateln)){
                    Toast.makeText(getApplicationContext(),"Nhập họ để cập nhật",Toast.LENGTH_LONG).show();
                    return;
                }
                else if(TextUtils.isEmpty(updatephno)){
                    Toast.makeText(getApplicationContext(),"Nhập số điện thoại để cập nhật",Toast.LENGTH_LONG).show();
                    return;
                }
                else if(TextUtils.isEmpty(updateadd)){
                    Toast.makeText(getApplicationContext(),"Nhập địa chỉ để cập nhật",Toast.LENGTH_LONG).show();
                    return;
                }
                else if(TextUtils.isEmpty(updatepc)){
                    Toast.makeText(getApplicationContext(),"Nhập mã pin để cập nhật",Toast.LENGTH_LONG).show();
                    return;
                }
                else{
                    if(verifythis.equals(semail)) {
                        ...
                        Toast.makeText(getApplicationContext(),"Nhập email chính xác",Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
        ...
        db.collection("Users").document(userid).set(user).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()) {
                    ...
                    Toast.makeText(ProfileCustomer.this,"Thông tin được cập nhật thành công", Toast.LENGTH_LONG).show();
