...
public class BookInfoOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bprice.setText(String.format("Bán @ %s VNĐ", sprice));
        rp.setText(String.format("Giá thuê: %s VNĐ mỗi ngày", rprice));
        dc.setText(String.format("Phí vận chuyển: %s VNĐ", dprice));
        ...
        buybook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(quantities==0)
                {
                    Toast.makeText(BookInfoOrder.this, "Xin lỗi, sách hiện không có sẵn \uD83D\uDE22", Toast.LENGTH_SHORT).show();
                }
                else {
