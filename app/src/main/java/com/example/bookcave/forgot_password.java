        ...
        sentemailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(remail)){
                    ...
                    firebaseAuth.sendPasswordResetEmail(remail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(forgot_password.this,"Kiểm tra hộp thư đến email của bạn", Toast.LENGTH_LONG).show();
                            }else{
                    ...
                    Toast.makeText(forgot_password.this,"Nhập email", Toast.LENGTH_LONG).show();
                }
