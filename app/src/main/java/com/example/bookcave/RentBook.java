    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                total=newsp+dprice;
                oitemprice.setText(String.format("%s VNĐ", String.valueOf(newsp)));
                ototalprice.setText(String.format("%s VNĐ", String.valueOf(total)));
                famount.setText(String.format("VNĐ %s", String.valueOf(total)));
            }
        ...
        oprice.setText(String.format("%s VNĐ", String.valueOf(sprice)));
        ogenre.setText("");
        oitemprice.setText(String.format("%s VNĐ", String.valueOf(sprice)));
        odeliprice.setText(String.format("%s VNĐ", String.valueOf(dprice)));
        //total=sprice+dprice;
        ototalprice.setText(String.format("%s VNĐ", String.valueOf(total)));
        famount.setText(String.format("VNĐ %s", String.valueOf(total)));
        ...
        order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(opin.getText().toString().trim().length()<6) {
                    Toast.makeText(RentBook.this, "Mã pin phải có 6 chữ số", Toast.LENGTH_SHORT).show();
                }
                if(TextUtils.isEmpty(oaddress.getText().toString().trim())){
                    Toast.makeText(getApplicationContext(),"Vui lòng nhập địa chỉ của bạn",Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                db.collection("Orders").document(uniqueid).set(order).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(RentBook.this, "Đã đặt hàng \uD83C\uDF89", Toast.LENGTH_LONG).show();
